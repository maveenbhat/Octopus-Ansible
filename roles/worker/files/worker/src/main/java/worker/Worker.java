...
class Worker {
  ...
  static Connection connectToDB() throws SQLException {
    ...
    try {
      ...
      String url = "jdbc:postgresql://" + System.getenv("POSTGRESQL_HOST") + ':' + System.getenv("POSTGRESQL_PORT")+ "/" + System.getenv("POSTGRESQL_DB");

      while (conn == null) {
        try {
          conn = DriverManager.getConnection(url, System.getenv("POSTGRESQL_USER"), System.getenv("POSTGRESQL_PASSWORD"));
        } catch (SQLException e) {
